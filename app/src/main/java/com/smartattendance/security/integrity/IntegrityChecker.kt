...
class PlayIntegrityChecker(
    ...
    private companion object {
         ...
         *  قبلاً ۷ ثانیه بود؛ چون این بررسی جلوی ارسال توکن صوتی را می‌گیرد و اگر سرورهای
         *  گوگل در دسترس نباشند (شبکه‌های محدودشده) کل این مدت هدر می‌رفت و باعث می‌شد
         *  توکن صوتیِ هنوز معتبر، تا رسیدن درخواست به سرور منقضی شود. */
